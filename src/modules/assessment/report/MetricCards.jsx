  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
      ...
      <div className="bg-white border border-zinc-200 p-5 rounded-xl text-center shadow-xs">
        ...
        <span className="text-2xl font-extrabold text-[#2B7FFF] block mt-2">₹{displayCorpus}</span>
      ...
      <div className="bg-white border border-zinc-200 p-5 rounded-xl text-center shadow-xs">
        ...
        <span className="text-2xl font-extrabold text-[#2B7FFF] block mt-2">₹{displayInsurance}</span>
